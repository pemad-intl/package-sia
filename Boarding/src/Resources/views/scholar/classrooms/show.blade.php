		...
		<div class="col-md-8">
			<div class="card mb-4">
				<div class="card-header">
				    <i class="mdi mdi-account-details mr-2 float-left"></i>Daftar siswa Tahun Ajaran <strong>{{ $classroom->semester->full_name }}</strong>
				</div>
				<div class="card-body">
					<form action="{{ route('administration::scholar.classrooms.students', ['classroom' => $classroom->id]) }}" method="POST"> @csrf @method('PUT')
						<div class="form-group">
							<select multiple="multiple" size="10" name="stsems[]">
