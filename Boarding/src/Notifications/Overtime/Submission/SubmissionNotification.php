...
class SubmissionNotification extends Notification implements ShouldQueue
{
     ...
     */
    public function __construct(EmployeeOvertime $overtime, ?EmployeePosition $position)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line($this->overtime->employee->user->name . ' mengajukan lembur ' . $this->overtime->name . '' . ($this->position ? ' yang telah disetujui oleh ' . $this->position->position->name . ' ' : '') . ', klik tombol di bawah untuk lihat detailnya.')
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'message' => $this->overtime->employee->user->name . ' mengajukan lembur' . ($this->position ? ' yang telah disetujui oleh ' . $this->position->position->name : '') . ', cek sekarang!',
