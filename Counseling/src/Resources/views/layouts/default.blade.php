...
@section('titleTemplate', config('counseling.name'))
...
@section('body-content')
    ...
    @if (session('success'))
        <div class="alert alert-success bg-success rounded-0 mb-0 border-0 px-0 text-white">
            <div class="container">
    ...
    @endif
    @if (session('danger'))
        <div class="alert alert-danger bg-danger rounded-0 mb-0 border-0 px-0 text-white">
            <div class="container">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                {!! session('danger') !!}
            </div>
    ...
    <div class="vertical-menu">
        <div data-simplebar class="h-100">
            <div id="sidebar-menu">
                ...
                @include('counseling::layouts.includes.subbar')
            </div>
        </div>
    </div>
    ...
    {{-- <div id="app" class="py-sm-4 page-fade py-3">
        <main>
            <div class="container">
                @yield('content')
            </div>
