        ...
        <div class="col-md-7 col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('counseling::counselings.index') }}" method="GET">
                        <div class="input-group mb-2">
                            <input class="form-control" name="search" type="text" value="{{ request('search') }}" placeholder="Cari nama/deskripsi disini ...">
                            <div class="input-group-append">
                                <a class="btn btn-outline-secondary" href="{{ route('counseling::counselings.index') }}"><i class="mdi mdi-refresh"></i></a>
                            ...
                            @forelse($counselings as $counseling)
                                <tr>
                                    ...
                                    <td nowrap class="py-2 text-right align-middle">
                                        <a class="btn btn-warning btn-sm" href="{{ route('counseling::counselings.edit', ['counseling' => $counseling->id]) }}" data-toggle="tooltip" title="Ubah"><i class="mdi mdi-pencil-outline"></i></a>
