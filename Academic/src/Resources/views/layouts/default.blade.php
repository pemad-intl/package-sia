...
@section('titleTemplate', config('academic.name'))
...
@section('body-content')
    <header id="page-topbar">
        <div class="navbar-header">
            ...
            <div class="d-flex">
                ...
                @include('academic::layouts.components.notifications')
    ...
    <div class="vertical-menu">
        <div data-simplebar class="h-100">
            <div id="sidebar-menu">
                @include('academic::layouts.includes.subbar')
            </div>
        </div>
    </div>
    ...
    @push('script')
        ...
        <script type="text/javascript">
            ...
            (function() {
                ...
                s1.async = true;
                s1.src = 'https://embed.tawk.to/5feacf0edf060f156a917799/1eqmjhl1k';
                s1.charset = 'UTF-8';
