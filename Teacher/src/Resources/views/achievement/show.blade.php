...
@section('title', 'Prestasi Rombel - '.$cls->name)
                            ...
                            <tbody>
                                @forelse($cls->stsems as $stsem)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('teacher::achievement.index', ['classroom' => $stsem->id, 'student' => $stsem->id]) }}" class="btn btn-info" title="Isikan Prestasi">
