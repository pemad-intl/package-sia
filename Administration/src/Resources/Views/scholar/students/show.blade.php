                        ...
                        @if (request('smt'))
                            ...
                            <div class="list-group">
                                @forelse($stsem->classroom->meets as $meet)
                                    @php($collapseId = 'accordion-assessment-' . $meet->id)
                                    <a
                                    ...
                                    >
                                        <div class="fw-bold me-2">
                                            <i style="color:{{ $meet->props->color }}" class="mdi mdi-label"></i> {{ $meet->subject->name }}
                                        </div>
                                    </a>

                                    @php($assessments = $stsem->assessments->where('subject_id', $meet->subject_id))
                                    <div id="{{ $collapseId }}" class="collapse list-group-item list-group-item-flush p-0">
                                        @forelse($assessments as $assessment)
                                            <div class="list-group-item d-flex justify-content-between">
                                                <div class="fw-bold">{{ $assessment->type_name }}</div>
